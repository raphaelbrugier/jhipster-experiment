...
public class AbstractCassandraTest {
    ...
    private static final String CASSANDRA_UNIT_RNDPORT_YAML = "cassandra-rdmport.yaml";
    ...
    public static void startServer() throws InterruptedException, TTransportException, ConfigurationException, IOException, URISyntaxException  {
        if (! started) {
            EmbeddedCassandraServerHelper.startEmbeddedCassandra(CASSANDRA_UNIT_RNDPORT_YAML, CASSANDRA_TIMEOUT);
